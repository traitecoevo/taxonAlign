...
sample_taxonomic_resources <- function() {
  tibble::tribble(
    ...
    "Boronia pinnata var. pinnata Sm.", "Boronia pinnata var. pinnata", "variety", "accepted", "TEST", "Boronia", "sp2", "sp2",
    ...
    "Boronia oldname Sm.", "Boronia oldname", "species", "synonym", "TEST", "Zieria", "sp3", "sp1",
    ...
    "Boronia missingaccepted Sm.", "Boronia missingaccepted", "species", "synonym", "TEST", "Boronia", "sp4", "sp99",
    "Boronia Sm.", "Boronia", "genus", "accepted", "TEST", NA_character_, "g1", "g1",
    "Boronella F.Muell.", "Boronella", "genus", "synonym", "TEST", NA_character_, "g2", "g1",
    "Rutaceae Juss.", "Rutaceae", "family", "accepted", "TEST", NA_character_, "f1", "f1",
    "Sapindales Juss.", "Sapindales", "order", "accepted", "TEST", NA_character_, "o1", "o1",
    "Oldorderia Endl.", "Oldorderia", "order", "synonym", "TEST", NA_character_, "o2", "o1",
    "Zanthoxyleae Nees.", "Zanthoxyleae", "tribe", "accepted", "TEST", NA_character_, "t1", "t1",
    "Valvatae Endl.", "Valvatae", "subgenus", "accepted", "TEST", "Boronia", "sg1", "sg1"
  )
}
